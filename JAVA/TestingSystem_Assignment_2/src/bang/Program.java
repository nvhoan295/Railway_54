...
public class Program {
	public static void main(String[] args) {
		...
		Account acc1 = new Account(1, "admin@gmail.com", "Username1", "Fullname1", dep4, pos1, LocalDate.of(2020, 12, 23));
...
//			Sử dụng toán tử ternary để làm Question 1
		...
		System.out.println(acc1.getDepartment() == null ? "Nhân viên chưa có phòng ban" : "Phòng ban của nhân viên là "+ acc2.getDepartment().getName());
...
//			Nếu không phải thì in ra text "Người này không phải là Developer"
		...
		System.out.println(acc1.getPosition().getName().toString() == "DEV" ? "Đây là Developer" : "Người này không phải là Developer");
